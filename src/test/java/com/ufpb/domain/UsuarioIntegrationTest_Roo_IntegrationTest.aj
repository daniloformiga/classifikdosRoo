...
import com.ufpb.domain.UsuarioIntegrationTest;
...
privileged aspect UsuarioIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    UsuarioRepository UsuarioIntegrationTest.usuarioRepository;
    
    @Test
    public void UsuarioIntegrationTest.testCount() {
    ...
    @Test
    public void UsuarioIntegrationTest.testFind() {
        ...
        obj = usuarioRepository.findOne(id);
    ...
    @Test
    public void UsuarioIntegrationTest.testFindAll() {
        Assert.assertNotNull("Data on demand for 'Usuario' failed to initialize correctly", dod.getRandomUsuario());
        long count = usuarioRepository.count();
    ...
    @Test
    public void UsuarioIntegrationTest.testFindEntries() {
        Assert.assertNotNull("Data on demand for 'Usuario' failed to initialize correctly", dod.getRandomUsuario());
        long count = usuarioRepository.count();
        if (count > 20) count = 20;
        int firstResult = 0;
        int maxResults = (int) count;
        List<Usuario> result = usuarioRepository.findAll(new org.springframework.data.domain.PageRequest(firstResult / maxResults, maxResults)).getContent();
    ...
    @Test
    public void UsuarioIntegrationTest.testSaveUpdate() {
        Usuario obj = dod.getRandomUsuario();
        Assert.assertNotNull("Data on demand for 'Usuario' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Usuario' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifyUsuario(obj);
        Integer currentVersion = obj.getVersion();
        Usuario merged = usuarioRepository.save(obj);
        usuarioRepository.flush();
    ...
    @Test
    public void UsuarioIntegrationTest.testSave() {
        Assert.assertNotNull("Data on demand for 'Usuario' failed to initialize correctly", dod.getRandomUsuario());
    ...
    @Test
    public void UsuarioIntegrationTest.testDelete() {
        Usuario obj = dod.getRandomUsuario();
        Assert.assertNotNull("Data on demand for 'Usuario' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Usuario' failed to provide an identifier", id);
        ...
        usuarioRepository.flush();
        Assert.assertNull("Failed to remove 'Usuario' with identifier '" + id + "'", usuarioRepository.findOne(id));
    }
